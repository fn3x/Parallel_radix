...
/* package Huskell-0.1.0.0 */
#ifndef VERSION_Huskell
#define VERSION_Huskell "0.1.0.0"
#endif /* VERSION_Huskell */
#ifndef MIN_VERSION_Huskell
#define MIN_VERSION_Huskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Huskell */
...
#define CURRENT_COMPONENT_ID "Huskell-0.1.0.0-inplace-Huskell"
